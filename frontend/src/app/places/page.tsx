                ...
                {user && (
                  <div className="border-t border-gray-200 my-4 pt-4">
                    <ReviewForm 
                      ...
                      userId={user.user_id} 
                      onReviewSubmitted={() => fetchPlaceDetails(selectedPlace.place_id)}
                      existingReview={
                        selectedPlace.reviews?.find(review => review.user_id === user.user_id)
                          ? {
                              stars: selectedPlace.reviews.find(review => review.user_id === user.user_id)!.stars,
                              comment: selectedPlace.reviews.find(review => review.user_id === user.user_id)!.comment || ''
                            }
                          : undefined
                      }
                    />
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        router.push(`/reviews/${selectedPlace.place_id}`);
                      }}
                    >
                      See all reviews
